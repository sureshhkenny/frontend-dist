...
if (Object(_lib_supported_browser__WEBPACK_IMPORTED_MODULE_9__["default"])()) {
  ...
  console.log("wrappedcomponent", WrappedBrowserModalComponent);
...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  var WrappedGui = Object(redux__WEBPACK_IMPORTED_MODULE_2__["compose"])( //  App,
  _lib_app_state_hoc_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], _lib_hash_parser_hoc_jsx__WEBPACK_IMPORTED_MODULE_5__["default"])(_containers_gui_jsx__WEBPACK_IMPORTED_MODULE_4__["default"]);
  console.log("WrappedGui", WrappedGui); // TODO a hack for testing the backpack, allow backpack host to be set by url param
  ...
  console.log("backpackHost", backpackHost);
  ...
  console.log("projectFileMatches", projectFileMatches);
  var projectFile = projectFileMatches ? decodeURIComponent(projectFileMatches[1]) : null;
  console.log("projectFile", projectFile);
  console.log("decodeURIComponent(projectFileMatches[1])", decodeURIComponent(projectFileMatches[1]));
  ...
  simulateScratchDesktop ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WrappedGui, {
    ...
    canSave: true,
    onClickLogo: onClickLogo // onVmInit={onVmInit}
